    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (action.equals("Search")) {
                ...
                String department = request.getParameter("cboDepartment");
                Context ctx = new InitialContext();
                Object obj = ctx.lookup("ReJNDI");
                RecruitmentSessionBeanRemote remote = (RecruitmentSessionBeanRemote) obj;
                List result = remote.getHomepage(title,department);
